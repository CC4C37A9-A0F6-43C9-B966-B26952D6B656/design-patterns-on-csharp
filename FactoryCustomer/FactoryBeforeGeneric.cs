...
namespace FactoryCustomer
{
    ...
    /// </summary>
    public static class FactoryBeforeGeneric //public class Factory //BEFORE Step 8:- Improving performance of Factory class
    {
        ...
        //    };
        //}
        static FactoryBeforeGeneric()
        {
            //customers = new Lazy<List<ICustomer>>(() => LoadCustomers()); //removed from Step 11:- Automating Simple Factory using Unity
            cont = new UnityContainer();
            cont.RegisterType<ICustomer, Lead>("0");//cont.RegisterType < ICustomer,Lead = "" > ("0");
            cont.RegisterType<ICustomer, Customer>("1");//cont.RegisterType < ICustomer,Customer = "" > ("1");
        }
